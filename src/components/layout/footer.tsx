...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full max-w-7xl xl:max-w-6xl mx-auto flex flex-col items-center justify-center rounded-t-[2.5rem] md:rounded-t-[3.5rem] border-t border-white/5 bg-slate-900 px-6 py-8 md:py-10 overflow-hidden">
      {/* Subtle Top Glow */}
