    ...
    <div className="min-h-screen w-full bg-white relative overflow-x-hidden">
      <div className="relative z-10 flex flex-col">
        ...
        <section className="relative flex flex-col overflow-hidden">
          ...
          {/* DESKTOP HERO - Expanded to match screenshot layout */}
          <div className="hidden md:flex relative -mt-24 lg:-mt-36 min-h-[650px] lg:min-h-[850px] items-center bg-white">
            ...
            <div className="container mx-auto px-4 md:px-12 lg:px-20 max-w-screen-2xl relative z-10 pt-24 lg:pt-40">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-10">
                  <div className="space-y-6">
                    <Badge variant="outline" className="text-primary border-primary/30 font-black tracking-[0.2em] uppercase py-2 px-5 text-[10px] rounded-lg bg-white/95 backdrop-blur-md shadow-sm w-fit border-2">
                      20+ Years of Excellence
                    </Badge>
                    <h1 className="text-6xl md:text-7xl lg:text-8xl font-black font-headline text-slate-900 leading-[1.05] tracking-tight uppercase drop-shadow-sm">
                      ADVANCED <br />WATER TREATMENT <br />FOR <span className="text-primary">EVERY SECTOR</span>
                    </h1>
                  ...
                  <div className="flex flex-wrap gap-6 pt-2">
                    <Button asChild size="lg" className="h-16 px-12 rounded-xl text-lg font-black bg-primary text-white hover:bg-primary/90 transition-all border-none shadow-2xl shadow-primary/20">
                      <Link href="/contact" className="flex items-center gap-3">Get a Quote <ArrowRight className="h-5 w-5" /></Link>
                    </Button>
                    <Button asChild size="lg" variant="outline" className="h-16 px-12 rounded-xl text-lg font-black border-2 border-slate-200 hover:bg-white/80 text-slate-900 transition-all bg-white/40 backdrop-blur-sm">
                      <Link href="/products">View Catalog</Link>
                    </Button>
                  </div>

                  <div className="flex flex-wrap items-center gap-x-12 gap-y-4 text-xs font-black text-slate-900 pt-10 uppercase tracking-[0.2em]">
                    <div className="flex items-center gap-4">
                      <div className="p-3 rounded-2xl bg-white/90 backdrop-blur-md border border-primary/20 shadow-sm transition-transform hover:scale-110"><ShieldCheck className="h-6 w-6 text-primary" /></div>
                      <span>Certified Purity</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="p-3 rounded-2xl bg-white/90 backdrop-blur-md border border-primary/20 shadow-sm transition-transform hover:scale-110"><Activity className="h-6 w-6 text-primary" /></div>
