    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-5xl md:text-8xl font-black font-headline tracking-tight leading-[1.05] uppercase">
              Drinking <br />Water <span className="text-slate-900">Hub</span>
            </h1>
            <p className="text-xl md:text-2xl text-white font-bold leading-relaxed max-w-2xl opacity-90">
              High-performance Reverse Osmosis and purification plants delivering WHO-standard drinking water for large-scale operations.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 p-8 bg-white rounded-3xl shadow-xl border border-slate-100 max-w-xs hidden md:block">
                ...
                <p className="text-xs font-bold text-slate-400">Our plants retain essential minerals while removing 99.9% of harmful TDS and bacteria.</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-slate-600 font-bold leading-relaxed">
                AquaSafe Drinking Water Plants are engineered for reliability and precision. From source water analysis to final mineralization, our multi-stage process ensures every drop is a testament to engineering excellence.
              </p>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-slate-100 hover:shadow-xl transition-all space-y-6">
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <h2 className="text-4xl font-black font-headline mb-16 uppercase tracking-tight">Mission Critical Applications</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {["Bottling Plants", "Hospitals", "School Campus", "Hotels & Labs"].map((app, i) => (
              <div key={i} className="p-8 rounded-3xl bg-slate-900 text-white space-y-4 group hover:bg-primary transition-all">
                <div className="aspect-square rounded-2xl bg-white/10 flex items-center justify-center mb-4 group-hover:bg-white group-hover:text-primary transition-all">
                  <Factory className="h-8 w-8" />
                </div>
                <h4 className="font-black uppercase tracking-widest text-xs">{app}</h4>
              </div>
            ))}
          </div>
        </div>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem value="item-1" className="border border-white/10 rounded-2xl px-6 bg-white/5">
              ...
              <AccordionContent className="text-slate-400 font-bold pb-6">
                Standard maintenance (filter changes) occurs every 3-6 months. We provide automated reminders and predictive AMC auditing for industrial units.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2" className="border border-white/10 rounded-2xl px-6 bg-white/5">
              ...
              <AccordionContent className="text-slate-400 font-bold pb-6">
                Yes, our industrial-grade membranes can process source water with TDS up to 3000ppm and still deliver WHO-standard output.
              </AccordionContent>
            </AccordionItem>
          </Accordion>

          <div className="mt-20 flex flex-col items-center gap-8">
            <p className="text-slate-400 font-bold uppercase tracking-widest text-xs">Need a full laboratory water test?</p>
